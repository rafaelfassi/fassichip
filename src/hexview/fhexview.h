...
class FHexView : public QAbstractScrollArea {
        Q_OBJECT
...
public:
        ...
        void SetPointer(int _Pointer) { Pointer = _Pointer; repaint(); }
        void SetSelection(int _Start, int _End);
...
private:
        ...
        QByteArray ReadData(int _Offset, int _NBytes) const;
